...
import { normalizeResumeCssSelectors } from '@/shared/resumeDocument/normalizeResumeCssSelectors';
...
export function hydrateResumeData(data: object) {
    const savedData = normalizeResumeCssSelectors(data as ResumeSaveData);
