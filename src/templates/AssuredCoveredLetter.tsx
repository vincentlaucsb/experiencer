...
I am committed to helping great companies like yours build great products. I look forward to hearing from you soon.`
                },
                {
                    ...
                    childNodes: [
                        ...
                        {
                            type: Image.type,
                            value: joeBlowSignature,
                            altText: "Handwritten signature of Joe Blow"
                        } as BasicImageProps,
                        {
                            type: MarkdownText.type,
                            value: "Joe Blow"
